...
Creation Date:  Monday, October 28th 2019, 2:12:25 pm
File: test.py
'''
...
("Throttle Percent", obd.commands.THROTTLE_ACTUATOR),
("Trouble Codes", obd.commands.GET_DTC)]
#get all querys from vehicle
print(car.query(obd.commands.THROTTLE_ACTUATOR).value)
if(not car.status()): print("Failed Query, please try again")
else :
